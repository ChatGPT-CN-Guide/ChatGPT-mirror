# ChatGPT 镜像网站大全：2025年最全面的资源和最佳使用方法【3月持续更新】
...
2. [https://gptcat.net/](https://gptcat.net/) ——  运营时长一年半，一比一还原官网，可以使用GPT4o的实时语音对话。支持Claude3，开通会员后可以同时使用GPT-o1、GPT-o3与Claude，支持使用canvas模型。
